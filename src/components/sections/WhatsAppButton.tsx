...
export default function WhatsAppButton({ number, productName }: Props) {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-4 z-50 flex items-center gap-2 rounded-full bg-[#25D366] text-white shadow-xl shadow-black/20 pl-3 pr-4 py-3 hover:scale-105 active:scale-95 transition-transform"
    >
